...
def main():
    ...
    with st.sidebar:
        ...
        base_url = st.text_input(
            ...
            value=os.getenv("OPENAI_BASE_URL", "") or os.getenv("OPENAI_API_BASE", ""),
            placeholder="e.g. https://openai.vocareum.com/v1",
            help="Only needed for classroom/proxy keys (e.g. Vocareum) that "
                 "don't authenticate against the real api.openai.com. Leave "
                 "blank to use the standard OpenAI endpoint."
        )
        ...
        mission_choice = st.selectbox(
            ...
            help="Restrict retrieval to a single mission's documents, or search across all of them"
        )
        mission_filter_map = {
            "All Missions": None,
            "Apollo 11": "apollo_11",
        ...
        mission_filter = mission_filter_map[mission_choice]
